...
const CustomCard = () => {
  return (
    <div className="border-1 border-gray-300 flex overflow-hidden flex-col rounded-xl p-6 mt-10 w-[350px] cursor-pointer shadow-md hover:shadow-gray-200 transition-all duration-300">
